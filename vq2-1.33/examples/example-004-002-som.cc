...
int main(int argc, char* argv[]) {
  ...
  // HANDCRAFTED code section) This function returns a vector with the
  // created RefVertex references.
  std::vector<RefVertex> line = vq2::algo::make::ring(som,LINE_SIZE,
						      init_vertex,
						      init_edge);
