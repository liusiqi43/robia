...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_d2H3f.pack(_x.drone_time, _x.tag, _x.size, _x.angular_rates_trim_r, _x.euler_angles_trim_theta, _x.euler_angles_trim_phi))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drone_time, _x.tag, _x.size, _x.angular_rates_trim_r, _x.euler_angles_trim_theta, _x.euler_angles_trim_phi,) = _struct_d2H3f.unpack(str[start:end])
      return self
