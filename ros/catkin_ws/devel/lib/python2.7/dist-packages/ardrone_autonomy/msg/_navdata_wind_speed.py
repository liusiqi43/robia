...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_d2H13f.pack(_x.drone_time, _x.tag, _x.size, _x.wind_speed, _x.wind_angle, _x.wind_compensation_theta, _x.wind_compensation_phi, _x.state_x1, _x.state_x2, _x.state_x3, _x.state_x4, _x.state_x5, _x.state_x6, _x.magneto_debug1, _x.magneto_debug2, _x.magneto_debug3))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drone_time, _x.tag, _x.size, _x.wind_speed, _x.wind_angle, _x.wind_compensation_theta, _x.wind_compensation_phi, _x.state_x1, _x.state_x2, _x.state_x3, _x.state_x4, _x.state_x5, _x.state_x6, _x.magneto_debug1, _x.magneto_debug2, _x.magneto_debug3,) = _struct_d2H13f.unpack(str[start:end])
      return self
