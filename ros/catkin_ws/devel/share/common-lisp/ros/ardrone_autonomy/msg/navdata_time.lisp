...
(cl:defclass <navdata_time> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass navdata_time (<navdata_time>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <navdata_time>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'navdata_time)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ardrone_autonomy-msg:<navdata_time> is deprecated: use ardrone_autonomy-msg:navdata_time instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <navdata_time>))
...
(cl:defmethod drone_time-val ((m <navdata_time>))
...
(cl:defmethod tag-val ((m <navdata_time>))
...
(cl:defmethod size-val ((m <navdata_time>))
...
(cl:defmethod time-val ((m <navdata_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ardrone_autonomy-msg:time-val is deprecated.  Use ardrone_autonomy-msg:time instead.")
  (time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <navdata_time>) ostream)
  "Serializes a message object of type '<navdata_time>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <navdata_time>) istream)
  "Deserializes a message object of type '<navdata_time>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<navdata_time>)))
  "Returns string type for a message object of type '<navdata_time>"
  "ardrone_autonomy/navdata_time")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'navdata_time)))
  "Returns string type for a message object of type 'navdata_time"
  "ardrone_autonomy/navdata_time")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<navdata_time>)))
  "Returns md5sum for a message object of type '<navdata_time>"
  "8642a5656fdcc9310938a1807c46d608")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'navdata_time)))
  "Returns md5sum for a message object of type 'navdata_time"
  "8642a5656fdcc9310938a1807c46d608")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<navdata_time>)))
  "Returns full string definition for message of type '<navdata_time>"
  (cl:format cl:nil "Header header~%float64 drone_time~%uint16 tag~%uint16 size~%uint32 time~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'navdata_time)))
  "Returns full string definition for message of type 'navdata_time"
  (cl:format cl:nil "Header header~%float64 drone_time~%uint16 tag~%uint16 size~%uint32 time~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <navdata_time>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <navdata_time>))
  "Converts a ROS message object to a list"
  (cl:list 'navdata_time
