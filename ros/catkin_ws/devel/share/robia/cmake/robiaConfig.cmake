...
if(robia_CONFIG_INCLUDED)
  return()
endif()
set(robia_CONFIG_INCLUDED TRUE)
...
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'robia' is deprecated")
...
set(robia_FOUND_CATKIN_PROJECT TRUE)

if(NOT "" STREQUAL "")
  set(robia_INCLUDE_DIRS "")
  set(_include_dirs "")
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir}" STREQUAL "include")
      get_filename_component(include "${robia_DIR}/../../../include" ABSOLUTE)
      ...
      message(FATAL_ERROR "Project 'robia' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/siqi/Documents/robia/robia/ros/catkin_ws/src/robia/${idir}'.  Ask the maintainer 'siqi <siqi@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/siqi/Documents/robia/robia/ros/catkin_ws/devel/lib;/opt/ros/hydro/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(robia_LIBRARY_DIRS ${lib_path})
      list(APPEND robia_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'robia'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND robia_LIBRARIES ${lib})
    endif()
  endif()
...
set(robia_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${robia_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 robia_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${robia_dep}_FOUND)
      find_package(${robia_dep} REQUIRED)
    endif()
  else()
